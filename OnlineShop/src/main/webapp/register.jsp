...
<%@ taglib uri="poliakov.epam.com" prefix="mytags"%>
...
<div align="center" style="color: #ff0000"><h2>${requestScope.timeOver}</h2></div>
     ...
     <fmt:message key="file_upload" var="file_upload"/>

<div class="container">
	<div class="register">
		<h2>Registration</h2>
		  	  <form action="/OnlineShop/signUp" method="post" id="register_form" enctype="multipart/form-data">
				 <div class="col-md-6  register-top-grid">

					<div class="mation">
						<div id="error_first_name" style="color: #ff0000"></div>
						<div style="color: #ff0000">${requestScope.error.firstName}</div>
						<span>${first_name}</span>
						<input type="text" name="firstname" value="${requestScope.oldParam.firstName}" id="firstname">

						<div id="error_last_name" style="color: #ff0000"></div>
						<div style="color: #ff0000">${error.lastName}</div>
						<span>${last_name}</span>
						<input type="text" name="lastname" value="${requestScope.oldParam.lastName}" id="lastname">

						<div id="error_reg_login" style="color: #ff0000"></div>
						<div style="color: #ff0000">${requestScope.error.login}</div>
						<div style="color: #ff0000">${requestScope.loginExist}</div>
						<span>${login}</span>
						<input type="text" name="login" value="${requestScope.oldParam.login}" id="login">

						 <div id="error_email" style="color: #ff0000"></div>
						 <div style="color: #ff0000">${requestScope.error.email}</div>
						 <span>${email}</span>
						 <input type="text" name="email" value="${requestScope.oldParam.email}" id="email">
					</div>
            		 ...
            		 <div style="color: #00ff00" >${requestScope.captchaCorrect}</div>
            		 <div style="color: #ff0000" >${requestScope.captchaIncorrect}</div>
				     ...
				     <div class=" col-md-6 register-bottom-grid">
							...
							<div class="mation">
								...
								<div style="color: #ff0000">${requestScope.error.password}</div>
								<span>${password}</span>
								<input type="password" name="password" id="password">
								<div id="error_password_conf" style="color: #ff0000"></div>
								<div style="color: #ff0000">${requestScope.error.password_conf}</div>
				...
				<div class="register-but">
					   ...
					   <input type="submit" value="${sign_up}" id="submit1">
					   <div class="clearfix"> </div>
				</div>
		 </form>
  </div>
...
<div class="footer">
	<div class="container">
		...
		<div class="container">
				...
				<div class="clearfix"> </div>
				<p class="footer-class"> © 2017 Car Shop.</a> </p>
			</div>
	</div>
</div>
<!--
<script src="js/validation/validation.js"></script>-->
<!--<script src="js/validation/validationJS.js"></script>-->
