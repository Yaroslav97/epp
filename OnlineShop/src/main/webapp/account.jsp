	...
	<div class="header-top">
		<div class="container">
				<div class="col-sm-4 logo">
					<h1><a href="index.jsp">Youth <span>Fashion</span></a></h1>
				</div>
	...
	<div class="container">
		...
		<div class="account_grid">
			   <div class="col-md-6 login-right">
				<form action="/OnlineShop/signIn" method="post" id="login_form">

					<div id="error_login" style="color: #ff0000"></div>
					<div style="color: #ff0000">${requestScope.errorLogin}</div>
					<span>Login</span>
					<input type="text" name="login" id="login"> 
				
					<div id="error_password" style="color: #ff0000"></div>
					<div style="color: #ff0000">${requestScope.errorPass}</div>
					<span>Password</span>
					<input type="password" name="password" id="password"> 
					<div class="word-in">
				  		<a class="forgot" href="#">Forgot Your Password?</a>
				 		 <input type="submit" value="sign in" id="submitLog">
				  	</div>
			    </form>
			   </div>	
			    <div class="col-md-6 login-left">
				 ...
				 <a class="acount-btn" href="/OnlineShop/signUp">Create an Account</a>
			   </div>
			   <div class="clearfix"> </div>
			 </div>
	</div>
...
<!--  
<script src=validatortion/validationLogin.js"></script>

 -->
<script src="js/validation/validationJSLogin.js"></script>
